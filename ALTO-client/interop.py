...
print "--- http://tools.ietf.org/pdf/draft-gurbani-alto-interop-cases-01.pdf ---\n\n"
...
headers = {"Accept": "application/alto-endpointprop+json"}
conn = httplib.HTTPConnection(hostname + ":6671")
...
headers = {"Accept": "application/alto-endpointprop+json", "Content-Type": "application/alto-endpointpropparams+jason"}
conn = httplib.HTTPConnection(hostname + ":6671")
conn.request("POST", "/endpoints/property", params, headers)
response = conn.getresponse()
print(response.status, response.reason)
...
params = "{\
	\"constraints\": [\"le 5\", \"ge 4\"],\
        \"cost-mode\" : \"numerical\",\
          \"cost-type\" : \"routingcost\",\
          \"endpoints\" : {\
            \"srcs\": [ \"ipv4:10.0.0.1\", \"ipv4:192.168.11.0\", \"ipv4:192.168.10.0\" ],\
            \"dsts\": [\
		\"ipv4:10.0.0.0\",\
		\"ipv4:15.0.0.0\",\
		\"ipv4:192.168.11.0\",\
