...
#    endif
	...
	if (getnameinfo((struct sockaddr*)&prefix->add.sin6, sizeof(prefix->add.sin6), buff, 48, NULL, 0, NI_NUMERICHOST) == 0 && with_len) {
...
prefix_t *
New_Prefix2 (int family, const void *dest, int bitlen, prefix_t *prefix)
{
...
/*
 * if func is supplied, it will be called as func(NULL, node->data)
