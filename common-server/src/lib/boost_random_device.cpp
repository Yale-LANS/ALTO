/*
 * NOTE: This file has (for some reason) been removed from Boost
 * versions > 1.35.  Thus, we'll include it directly when we build,
 * instead of linking with boost_random.
 */
#ifdef __linux__
